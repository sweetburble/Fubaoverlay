...
'''
학습한 Neural Style Transfer 모델을 적용한다
...
def logic(filename):
    ...
    content_img_path = 'images/' + filename
    output_img_path = 'output_images/' + '[panda]' + filename
    saved_model_path = 'saved_models/panda_style_model.pth'
